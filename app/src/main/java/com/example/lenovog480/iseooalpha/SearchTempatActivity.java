...
import com.example.lenovog480.iseooalpha.adapter.TempatAdapter;
...
public class SearchTempatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_search_tempat);
    ...
    private void initCollapsingToolbar() {
        ...
        collapsingToolbar.setTitle("Search Venues");
    ...
    private void initViews(){
        ...
        adapter = new TempatAdapter(this, albumList);

        RecyclerView.LayoutManager mLayoutManager = new GridLayoutManager(this, 2);
        recyclerView.setLayoutManager(mLayoutManager);
        recyclerView.addItemDecoration(new SearchTempatActivity.GridSpacingItemDecoration(2, dpToPx(10), true));
    ...
    private void loadJSON(){
        try {
            ...
            Call<JasaModel> call = api.viewTempat();
            call.enqueue(new Callback<JasaModel>() {
                ...
                public void onResponse(Call<JasaModel> call, Response<JasaModel> response) {
                    ...
                    recyclerView.setAdapter(new TempatAdapter(getApplicationContext(), items));
                ...
                public void onFailure(Call<JasaModel> call, Throwable t) {
                    ...
                    Toast.makeText(SearchTempatActivity.this, "Error Fetching Data!", Toast.LENGTH_LONG).show();
                    pd.hide();
                }
            });
        }catch (Exception e){
